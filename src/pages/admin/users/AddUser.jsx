...
const AddUser = () => {
  const { loading, setLoading, getAllUsers, setShowAddUsers } =
  ...
  const addUserHandler = async (e) => {
    ...
    try {
      ...
      console.log(
        "🚀 ~ file: AddUser.jsx:40 ~ addProductHandler ~ response:",
        response
      );
      ...
      <div className="absolute bg-primary-color/40 top-0 left-0 z-10 min-h-screen min-w-full flex items-center justify-center">
        ...
        >
          <div className="w-full flex items-center justify-between">
            <span className="font-bold text-black-ish">Add User</span>
            <span
