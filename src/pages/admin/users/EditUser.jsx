...
const EditUser = () => {
  ...
  const editUserHandler = async (e) => {
    ...
    try {
      ...
      console.log(
        "🚀 ~ file: EditUser.jsx:39 ~ editUserHandler ~ response:",
        response
      );
  ...
  const deleteHandler = async () => {
    try {
      ...
      console.log(
        "🚀 ~ file: EditUser.jsx:69 ~ deleteHandler ~ response:",
        response
      );
    ...
    <>
      ...
      <div className="absolute bg-primary-color/40 top-0 left-0 z-10 min-h-screen min-w-full flex items-center justify-center">
        ...
        >
          ...
          <div className="w-full h-[25.5rem] bg-primary-color/5 rounded flex flex-col gap-3 p-2">
            {/* Pair */}
            ...
            {/* Pair */}
            <div className="flex flex-col items-start justify-center">
              <span className="font-semibold text-black-ish/50">Last Name</span>
              <input
                type="text"
                name="lastname"
                id="lastname"
            ...
            {/* Pair */}
            <div className="flex flex-col items-start justify-center">
              <span className="font-semibold text-black-ish/50">Email</span>
              <input
                type="email"
                name="email"
                id="email"
            ...
            {/* Pair */}
            <div className="flex flex-col items-start justify-center">
              <span className="font-semibold text-black-ish/50">Username</span>
              <input
                type="text"
                name="username"
                id="username"
            ...
            {/* Pair */}
            <div className="flex flex-col items-start justify-center">
              <span className="font-semibold text-black-ish/50">Password</span>
              <input
                type="text"
                name="password"
                id="password"
