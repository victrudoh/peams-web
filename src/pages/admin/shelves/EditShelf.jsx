...
const EditProduct = () => {
  ...
  const EditShelfHandler = async (e) => {
    setLoading(true);
    console.log("shelfDetails", shelfDetails);
    e.preventDefault();
    try {
      ...
      // console.log(
      //   "🚀 ~ file: EditProduct.jsx:41 ~ EditShelfHandler ~ response:",
      //   response
      // );
      if (response.status === 200) {
        success("Updated shelf successfully");
        getAllShelves();
