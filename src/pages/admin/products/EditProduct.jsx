...
const EditProduct = () => {
  ...
  const [productDetails, setProductDetails] = useState({
    ...
    batch_no: oneProduct?.batch_no,
    expiry_date: oneProduct?.expiry_date,
    expiry_threshhold: oneProduct?.expiry_threshhold,
    quantity: oneProduct?.quantity,
    unit: oneProduct?.unit,
    categoryId: oneProduct?.categoryId,
    shelfId: oneProduct?.shelfId,
  });
  ...
  const EditProductHandler = async (e) => {
    ...
    try {
      ...
      console.log(
        "🚀 ~ file: EditProduct.jsx:41 ~ EditProductHandler ~ response:",
        response
      );
  ...
  const deleteHandler = async () => {
    try {
      ...
      //  console.log("🚀 ~ file: EditProduct.jsx:72 ~ deleteHandler ~ response:", response)
      ...
      setLoading(false);
      console.log("🚀 ~ file: EditProduct.jsx:79 ~ deleteHandler ~ err:", err);
      ...
      <div className="absolute bg-primary-color/40 top-0 left-0 z-10 min-h-screen min-w-full flex items-center justify-center">
        ...
        >
          <div className="w-full flex items-center justify-between">
            <span className="font-bold text-black-ish">Edit Product</span>
            <span
          ...
          <div className="w-full h-[26rem] overflow-y-scroll bg-primary-color/5 rounded flex flex-col gap-3 p-2">
            ...
            <div className="flex flex-col items-start justify-center">
              ...
              <input
                ...
                id="batch_no"
                required
                defaultValue={oneProduct?.batch_no}
                onChange={onchangeHandler}
                className="w-full p-2 rounded-md outline-1 outline-primary-color/60 border-2 border-black-ish/20"
              />
            </div>
            ...
            <div className="flex flex-col items-start justify-center">
              ...
              <input
                ...
                id="expiry_date"
                required
                defaultValue={oneProduct?.expiry_date}
                onChange={onchangeHandler}
                className="w-full p-2 rounded-md outline-1 outline-primary-color/60 border-2 border-black-ish/20"
              />
            </div>
            ...
            <div className="flex flex-col items-start justify-center">
              ...
              <input
                ...
                required
                defaultValue={oneProduct?.expiry_threshhold}
                onChange={onchangeHandler}
                className="w-full p-2 rounded-md outline-1 outline-primary-color/60 border-2 border-black-ish/20"
              />
            </div>
            ...
            <div className="flex flex-col items-start justify-center">
              ...
              <select
                ...
                id="categoryId"
                required
                defaultValue={oneProduct?.categoryId}
                onChange={onchangeHandler}
            ...
            <div className="flex flex-col items-start justify-center">
              ...
              <select
                ...
                id="shelfId"
                required
                defaultValue={oneProduct?.shelfId}
                onChange={onchangeHandler}
                className="w-full p-2 rounded-md outline-1 bg-white-ish outline-primary-color/60 border-2 border-black-ish/20"
              >
              ...
              <>
                <div className="w-full flex justify-between items-center px-4">
                  <span
                    ...
                    className="p-2 rounded-md text-white-ish flex gap-1 items-center font-semibold cursor-pointer hover:animate-bounce"
                  >
                    <svg
                      width="14"
                      height="18"
